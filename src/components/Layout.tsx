  ...
  return (
    <div className="relative flex-none overflow-hidden px-6 lg:pointer-events-none lg:fixed lg:inset-0 lg:z-40 lg:flex lg:px-0">
      ...
      <div className="relative flex w-full lg:pointer-events-auto lg:mr-[calc(max(2rem,50%-38rem)+40rem)] lg:min-w-lg lg:overflow-x-hidden lg:overflow-y-auto lg:pl-[max(4rem,calc(50%-38rem))]">
        <div className="mx-auto max-w-lg lg:mx-0 lg:flex lg:w-96 lg:max-w-none lg:flex-col">
          <div className="pt-8 pb-16 sm:pt-12 sm:pb-20 lg:py-20">
          ...
          <div className="flex flex-1 items-end justify-center pb-4 lg:justify-start lg:pb-6">
            ...
            <a href="https://garunski.com">&copy; Garunski</a>
            </p>
          </div>
        </div>
      </div>
...
export function Layout({ children, sidebarMain }: LayoutProps) {
  return (
    <>
      <FixedSidebar
        main={sidebarMain}
      ...
      <div className="relative flex-auto">
        <Timeline />
        <main className="space-y-20 py-20 sm:space-y-20 sm:py-20">
          {children}
        </main>
      </div>
    </>
